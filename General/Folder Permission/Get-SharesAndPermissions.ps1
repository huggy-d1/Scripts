<#
.SYNOPSIS
Script to list all shares on a remote system and export folder permissions

.DESCRIPTION
This Script is used to check for all shares on the specified servers and to export folder permissions, the default shares like Admin$ and c$ 
are excluded from this script. 

This script requires that WMI and SMB are open and that the account run has the correct permissions. 
